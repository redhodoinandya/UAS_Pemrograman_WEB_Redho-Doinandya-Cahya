            ...
            <div class="pcoded-main-container">
                ...
                <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Data Kelulusan</div>
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Tambah Data Kelulusan</h5>
                                            <p class="text-muted m-b-10">Add Kelulusan</p>
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <form action="<?php echo base_url()?>Berita/Simpan_berita"
                                                            method="post" class="form-horizontal">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" name="xkategori"
                                                                        placeholder="isi">
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <input type="submit" class="btn btn-success btn-square" Value="Simpan">
                                                                        </form>

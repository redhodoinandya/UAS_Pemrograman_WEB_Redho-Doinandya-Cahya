                                    ...
                                    <div class="page-body">
                                      <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-blue order-card" style="width: 50rem;">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Jumlah Mahasiswa/i Lulus</h6>
                                                        <h2 class="text-right"><i class="ti-face-smile f-left"></i><span>
                                                            <?php 
                                                        echo $jumlah 
                                                        ?></span></h2>
                                                        <p class="m-b-0">Target Mahasiswa/i Lulus :<span class="f-right">75 Orang</span></p>
                                                    </div>
                                                </div>
                                            </div>
